...
pub mod podping_hive_write {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_hive_account(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::text::Owned>)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 56] = [
      ...
      ::capnp::word(130, 79, 135, 106, 102, 33, 19, 161),
      ::capnp::word(61, 0, 0, 0, 1, 0, 0, 0),
      ::capnp::word(124, 170, 35, 224, 148, 149, 29, 157),
      ...
      ::capnp::word(112, 105, 110, 103, 72, 105, 118, 101),
      ::capnp::word(87, 114, 105, 116, 101, 0, 0, 0),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(104, 105, 118, 101, 65, 99, 99, 111),
