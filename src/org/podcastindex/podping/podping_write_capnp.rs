...
pub mod podping_write {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_iri(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::text::Owned>)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 67] = [
      ...
      ::capnp::word(45, 0, 0, 0, 1, 0, 1, 0),
      ::capnp::word(194, 92, 95, 248, 145, 123, 145, 155),
      ...
      ::capnp::word(47, 112, 111, 100, 112, 105, 110, 103),
      ::capnp::word(95, 119, 114, 105, 116, 101, 46, 99),
      ::capnp::word(97, 112, 110, 112, 58, 80, 111, 100),
      ::capnp::word(112, 105, 110, 103, 87, 114, 105, 116),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(105, 114, 105, 0, 0, 0, 0, 0),
